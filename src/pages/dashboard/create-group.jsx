...
import { createGroup } from '../../utils/firebase/createData'
import { storage } from '../../utils/firebase'
import { stringToUsername } from '../../utils/helpers/strings'
...
const HomePage = () => {
  ...
  const submitNewDocument = async (data) => {
    if (imageToUpload && data && data.title) {
      const itemSlug = stringToUsername(data.title)
      const imageRef = ref(storage, `images/groups/${itemSlug}`)
    ...
    <>
      ...
      <main className="page_width_wide mx-auto flex w-full flex-row">
        ...
        <div className="min-h-screen w-full  p-5">
          <h2 className="mb-5 text-xl font-bold">Add a new group</h2>
