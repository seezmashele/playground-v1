...
import PostSidebar from '../../components/layout/Sidebar'
...
const EventPage = () => {
  ...
  return (
    <>
      ...
      <div className="border_color--main w-full border-b pb-7">
        <div className="post_width mx-auto flex w-full flex-grow select-none  overflow-hidden pt-7">
          <div className="flex w-3/5 items-center  ">
            <div className="pr-7">
              <div className="select-text text-3xl font-bold leading-tight">
                {postTitle}
              </div>
          ...
          <div className="box_radius image_bg w-3/5F h-96F relative h-[15.5rem] w-1/2 overflow-hidden">
            <img
      ...
      <div className="post_width mx-auto flex w-full">
            ...
            <div className="mt-10 flex justify-center">
              ...
              <div className="main_content_container flex-row pb-20">
                <div className="block w-full flex-grow">
                  <div className="text-[1.05rem]F leading-relaxedF mr-0 ml-auto block w-full max-w-xlF">
                    <LexicalComposer
