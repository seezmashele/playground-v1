      ...
      <div className="flex w-full select-none space-x-10">
        <div className="relative inline-block w-1/2 flex-grow">
          <div className="flex items-center text-sm">
            ...
            <div className="card_title hover:no-underline hover:cursor-default text-2xl max-w-xl font-bold mt-2 max-h-[7rem] overflow-hidden">
              {postTitle}
            </div>
          ...
          <div className="image_bg box_radius mt-5 relative top-0 left-0 inline-block h-80 w-full max-w-lg overflow-hidden">
            <img
              draggable="false"
          ...
          <div className="mt-5 flex space-x-3">
              ...
              <div className="border_color--main mt-7 w-full border-b" />
