      ...
      <div className="flex w-full select-none space-x-10">
        <div className="relative inline-block w-1/2 flex-grow overflow-hidden">
          ...
          <Link href={cardLink} passHref>
            <div className="card_title font-bold mt-2 max-h-[5rem] overflow-hidden">
              {cardTitle}
            </div>
          </Link>
        ...
        <Link href={cardLink} passHref>
          <div className="image_bg box_radius relative top-0 left-0 inline-block h-44 w-64 cursor-pointer overflow-hidden">
            <img
              draggable="false"
