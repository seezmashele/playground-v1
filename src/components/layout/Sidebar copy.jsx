...
const Sidebar = () => {
  ...
  return (
    <aside className="border_color--main sidebar_width border-lF sticky top-5 bottom-5 my-5 h-full min-h-screen flex-shrink-0 pb-0 pl-10 xs:hidden sidebar-breakpoint:block">
      {tempTags && (
        <>
          <SidebarTitle title="Trending Topics" />
          <div className="box_radius darkmode_transition mb-8 flex h-[8rem] w-full flex-grow flex-wrap gap-2.5 overflow-hidden">
